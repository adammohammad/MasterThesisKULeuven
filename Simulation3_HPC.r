...
# August 2017
# Code for fitting joint models and calculating their predictive performance (version for HPC cluster, Linux)
...
load("/home/mohammad/Comp/Alldata.RData")
source("/home/mohammad/Comp/functions.r")
...
r=as.numeric(Sys.getenv("SLURM_ARRAY_TASK_ID")) # get id of the job
...
outputName=paste("output",r,".RData",sep="")
outputPath=file.path("/home/mohammad/Comp",outputName) 
save(result,file=outputPath)
